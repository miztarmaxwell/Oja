    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-2xl w-full max-w-lg relative animate-fade-in-up">
                ...
                <div className="p-8">
                    <h2 className="text-2xl font-bold text-secondary dark:text-gray-200 mb-6 text-center">Add New Item</h2>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex items-center space-x-4">
                                <div className="h-20 w-20 rounded-md bg-gray-100 dark:bg-slate-700 border dark:border-slate-600 flex items-center justify-center">
                                    {imagePreview ? 
